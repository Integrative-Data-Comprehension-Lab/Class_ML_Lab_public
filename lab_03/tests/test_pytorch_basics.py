...
def test_train_lr_score_1():
    source_code = inspect.getsource(train_logistic_regression)   
    assert "nn.Linear(" not in source_code,  "You are NOT allowed to use nn.Linear() in train_logistic_regression()"
